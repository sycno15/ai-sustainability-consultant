...
This repository includes a Render configuration in render.yaml for deploying the backend service. The frontend is deployed separately on Vercel and the Link to it is: [ai-sustainability-consultant.vercel.app](https://ai-sustainability-consultant.vercel.app/)
